...
export class AboutMeService {
  ...
  getAboutMeByUsername = (username: String): Observable<any> => {
    let url = "http://ec2-54-89-234-156.compute-1.amazonaws.com:8080/aboutMe/get/" + username + "/";
  ...
  setAboutMeByUsername = (username: String, aboutMe: String): Observable<any> => {
    let url = "http://ec2-54-89-234-156.compute-1.amazonaws.com:8080/aboutMe/set";
