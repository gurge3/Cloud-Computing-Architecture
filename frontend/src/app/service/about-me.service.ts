...
export class AboutMeService {
  ...
  getAboutMeByUsername = (username: String): Observable<any> => {
    let url = "http://ec2-35-153-133-146.compute-1.amazonaws.com:8080/aboutMe/get/" + username + "/";
  ...
  setAboutMeByUsername = (username: String, aboutMe: String): Observable<any> => {
    let url = "http://ec2-35-153-133-146.compute-1.amazonaws.com:8080/aboutMe/set";
