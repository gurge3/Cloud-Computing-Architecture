...
export class UserService {
  ...
  login = (username: String, password: String): Observable<any> => {
    let url = "http://ec2-52-55-203-188.compute-1.amazonaws.com:8080/authenticate/login";
  ...
  register = (username: String, password: String): Observable<any> => {
    let url = "http://ec2-52-55-203-188.compute-1.amazonaws.com:8080/authenticate/register";
