...
export class UserService {
  ...
  login = (username: String, password: String): Observable<any> => {
    let url = "http://ec2-54-91-14-3.compute-1.amazonaws.com:8080/authenticate/login";
  ...
  register = (username: String, password: String): Observable<any> => {
    let url = "http://ec2-54-91-14-3.compute-1.amazonaws.com:8080/authenticate/register";
